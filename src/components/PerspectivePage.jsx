...
function perspectivePage() {
  ...
  const regions = hotspots.slice(0, 6);
  return (
    <section className='3dSection'>
      <svg version="1.1" width="100%" viewBox="590.8673469388159 20.8673469388159 739.2653061223682 739.2653061224264" id="svgParentElement">
        ...
        {regions.map((hotspot) => (
          <Link to={`/3D/${hotspot.entity_id}`}>
            <polygon key={hotspot.svg} points={hotspot.svg} fill="#74f570" fillOpacity="0.5" color="#74f570" opacity="0.9" width="1" strokeOpacity="0" stroke="white" strokeWidth="3"></polygon>
          </Link>
        ))}
      </svg>
    </section>
