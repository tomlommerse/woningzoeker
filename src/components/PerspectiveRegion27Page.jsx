...
function PerspectiveRegion27Page() {
    const { plots, hotspots } = jsonData;
    const plothotspots = hotspots.filter((hotspot) => hotspot.layer_id === 27);
        ...
        <section className='unscrollable'>
            <section id='js-3dsection' className='perspectiveSection svgTranslateY'>
                <svg id="js-svg" version="1.1" width="650%" viewBox="-351.9637681161985 -921.9637681158492 2624.9275362319313 2624.927536231815">
                    <image width="1920" height="780" href="https://backend.woningzoekerheijmans.nl/storage/219/woningzoeker_fase1_2.jpg"></image>
...
export default PerspectiveRegion27Page